...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #hiddenerrorterm
        hidden_error_term = hidden_error.T * self.sigmoid_output_2_derivative(hidden_outputs)
...
##########################################################
# if iteration done on 15000 give a very less train loss 
# Progress: 100.0% ... Training loss: 0.062 ... Validation loss: 0.129
#1500 iteration it generates training loss of 0.09
iterations = 1500
learning_rate = 2
hidden_nodes = 5
output_nodes = 1
